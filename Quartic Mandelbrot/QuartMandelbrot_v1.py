...
def calcnewz(c_vals, z):
	return addcomplex(sqcomplex(sqcomplex(z)), c_vals)   ## z = z^4 + c
...
print (c_list)
print("Almost done!")
filename = 'quartmandy_v1_1.csv'    ## <<<<<<< 	CHANGE THIS EVERY TIME
...
print ("This is v1 of quartic mandelbrot- inc =" + str(inc))
