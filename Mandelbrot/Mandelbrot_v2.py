...
##number)
##so that z never grow beyond the number 2

def calcnewz(c_vals, z):
	return addcomplex(sqcomplex(z), c_vals)
...
filename = 'mandel_v2_4.csv'  ## <<<<< CHANGE THIS EVERY TIME
...
print ("This is v2 of mandelbrot- inc = " + str(inc))

with open("log1.txt", "a") as myfile:
    myfile.write("This is v1 of quartic mandelbrot: inc = " + str(inc)+ ", maxiter = " + str(mi) + ", saved to: "+ filename + " at " + str(now_time) + "\n")
